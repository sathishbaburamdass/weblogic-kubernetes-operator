...
import oracle.weblogic.domain.*;
import oracle.weblogic.kubernetes.ItDomainUtilsWLST;
...
import static oracle.weblogic.kubernetes.utils.K8sEvents.*;
import static oracle.weblogic.kubernetes.utils.OperatorUtils.installAndVerifyOperator;
import static oracle.weblogic.kubernetes.utils.PatchDomainUtils.patchDomainResource;
import static oracle.weblogic.kubernetes.utils.PodUtils.*;
...
@IntegrationTest
class ItPodsRestartExistingDomain {
  ...
  public static void initAll(@Namespaces(2) List<String> namespaces) {
    ...
    logger.info("Running POD-RESTART TEST CASES on Already Deployed UPPER STACK DOMAIN");
    domainUid = "soainfra";
    clusterName = "soa_cluster";
    replicaCount = 2;
    opNamespace = "soainfra-operator-ns-2-03310453";
    domainNamespace = "soainfra-domain-ns-2-03310453";
