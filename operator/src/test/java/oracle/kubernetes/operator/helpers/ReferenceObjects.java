...
class ReferenceObjects {
  ...
  static final String MANAGED_MII_POD_3_0 =
        "metadata:\n"
        + "  annotations:\n"
        + "    prometheus.io/path: /wls-exporter/metrics\n"
        + "    prometheus.io/port: '8001'\n"
        + "    prometheus.io/scrape: 'true'\n"
        + "    weblogic.sha256: babc3246b60c05f3bbad7e5ff14acbd2c0ba75edb5b31e5c39f6e542533b2835\n"
        + "  labels:\n"
        + "    weblogic.domainName: domain1\n"
        + "    weblogic.serverName: ess_server1\n"
        + "    weblogic.domainRestartVersion: null\n"
  ...
  static final String ADMIN_MII_POD_3_0 = "metadata:\n"
        + "  annotations:\n"
        + "    prometheus.io/path: /wls-exporter/metrics\n"
        + "    prometheus.io/port: '7001'\n"
        + "    prometheus.io/scrape: 'true'\n"
        + "    weblogic.sha256: ee3c6a9aa6d76f01b0d38141d46d485e3e72aa85f3bc8eda055c54b93789b613\n"
        + "  labels:\n"
        + "    weblogic.domainName: domain1\n"
        + "    weblogic.serverName: ADMIN_SERVER\n"
        + "    weblogic.domainRestartVersion: null\n"
